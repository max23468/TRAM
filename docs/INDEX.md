...
| ADR GitHub | decisione operativa di pubblicazione repository | [`decisions/0002-github-publishing-and-repo-governance.md`](decisions/0002-github-publishing-and-repo-governance.md), [`OPERATIONS.md`](OPERATIONS.md), [`DECISIONS.md`](DECISIONS.md) | Repository privata, `main` protetto, CI/igiene repo, nessun deploy o release impliciti. |
