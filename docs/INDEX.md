...
| Roadmap e criteri successo | `tram-v1-mvp-roadmap-and-success-criteria-v0-1.md`, `tram-v1-mvp-development-verification-checklist-v0-1.md`, `tram-v1-mvp-v0-slice-status-alignment-2026-05-13.md` | [`../ROADMAP.md`](../ROADMAP.md), [`OPERATIONS.md`](OPERATIONS.md) | Fasi 0-6, Fase 4 corrente, slice S0-S11, criteri successo/fallimento, gate, debiti. |
| Roadmap futura | decisioni emerse nei documenti V1 e nei brief su V2/V3 | [`../ROADMAP.md`](../ROADMAP.md), [`CONTEXT.md`](CONTEXT.md), [`DECISIONS.md`](DECISIONS.md) | V1.1-V1.4, V2 confronto offerta-gara, V3 memoria storica e benchmark cross-gara. |
