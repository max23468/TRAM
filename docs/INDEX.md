...
6. [`docs/ARCHITECTURE.md`](ARCHITECTURE.md) - architettura e data model.
7. [`docs/AI_AND_DOCUMENT_PIPELINE.md`](AI_AND_DOCUMENT_PIPELINE.md) - pipeline documentale, AI, privacy e provider.
...
| ADR GitHub | decisione operativa di pubblicazione repository | [`decisions/0002-github-publishing-and-repo-governance.md`](decisions/0002-github-publishing-and-repo-governance.md), [`OPERATIONS.md`](OPERATIONS.md), [`DECISIONS.md`](DECISIONS.md) | Repository pubblica, CI/igiene repo, branch protection solo se decisa, nessun deploy o release impliciti. |
| ADR versioning/release | policy SemVer e rilascio | [`decisions/0003-versioning-release-policy.md`](decisions/0003-versioning-release-policy.md), [`OPERATIONS.md`](OPERATIONS.md), [`TOOLCHAIN.md`](TOOLCHAIN.md), [`DECISIONS.md`](DECISIONS.md) | `package.json` come fonte versione, SemVer `0.x`, `CHANGELOG.md` dalla prima release applicativa, release distinta da deploy. |
